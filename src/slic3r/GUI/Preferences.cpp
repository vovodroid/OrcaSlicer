...
wxWindow* PreferencesDialog::create_general_page()
{
    ...
    auto item_hide_options  = create_item_checkbox(_L("Hide unrelevant options"), page, _L("Hide in GUI options that can't be used in due other option combination.\nRestart slicer if you change it."), 50, "hide_options");
    ...
    sizer_page->Add(item_hide_options, 0, wxTOP, FromDIP(3));
